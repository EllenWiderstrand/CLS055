  ...
  return (
    <div className="wrapper">
        ...
        <p>There are millions of applications on the market but there are only a handful of them that millions of people around the world use on a daily basis [1], [2]. 
          ...
          Something that has the potential to become successful and popular, however, is platforms that support the already widely used applications [1]. 
          ...
          All recent updates are gathered which lets you keep up with all your favourite accounts, no matter which platform they are from. There is, therefore, 
