    ...
    return(
        <div className="wrapper"> 
            ...
            <p>
                ...
                showed that all interviewees use the same applications on a daily basis. Figure 4.1 shows which social media they use. 
                These statistics correlate quite well with the Statistics stated in “Mobile App Download Statistics and Usage Statistics“ [2]. 
                KeepUp, therefore, gives the user the possibility to decide which social media to include which makes it tailored for the users. 
                Thereby, KeepUp hopefully achieves the main core of the purpose by letting the user take control and gather all social media 
                on one website.
            </p>
            ...
            <p>
                ...
                have them turned off. By forcing the user to actively turn them on if they want notifications, they are less likely to have 
                them on. Another common feature on social media is to show the number of likes a post gets. In KeepUp, the default settings 
                for likes is to not show the number. The user can still see that people have liked or reacted to the post but can not see 
            ...
            <p>
                ...
                infinite scrolling since it can be very addictive [4]. When a user opens KeepUp, it is clearly stated how many new 
